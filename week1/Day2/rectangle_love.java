...
public class Solution {
    ...
    public static Rectangle findRectangularOverlap(Rectangle rect1, Rectangle rect2) {
        ...
        int rect1_rightX=rect1.getLeftX()+rect1.getWidth();
        int rect2_rightX=rect2.getLeftX()+rect2.getWidth();
        ...
        int result_width=Math.min(rect1_rightX,rect2_rightX)-result_leftX;
        int result_height=Math.min(rect1_topY,rect2_topY)-result_bottomY;
        if(rect1_topY==rect2.getBottomY() || rect1_rightX==rect2.getLeftX()) 
            return new Rectangle();
        else if(result_width<0 || result_height<0) 
            return new Rectangle();
        else 
            return new Rectangle(result_leftX,result_bottomY,result_width,result_height);
